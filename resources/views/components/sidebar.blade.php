    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item"><a href="#"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Ecommerce">Data Sales</span></a>
                    <ul class="menu-content">
                        <li><a href="{{route("listSales")}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Shop">Sales</span></a>
                        </li>
                        <li><a href="{{route("addSales")}}"><i class="feather icon-circle"></i><span class="menu-item" data-i18n="Shop">Tambah Data Sales</span></a>
                        </li>
                    </ul>
                </li>
